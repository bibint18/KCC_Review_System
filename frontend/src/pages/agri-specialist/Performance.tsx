      ...
      <Grid container spacing={2} sx={{ mb: 3 }}>
        {[
          ...
          },
          {
            ...
            icon: (
              <CheckCircleIcon fontSize="small" sx={{ color: "#6b7280" }} />
            ),
          },
          {
          ...
          },
          {
            ...
            icon: (
              <EmojiEventsIcon fontSize="small" sx={{ color: "#6b7280" }} />
            ),
          },
        ].map((stat, i) => (
        ...
        <Grid item xs={12} md={6}>
          <Paper sx={{ p: 3, borderRadius: "12px" }}>
            ...
            <Box sx={{ display: "flex", gap: 3, mb: 2 }}>
              ...
              >
                <Typography sx={{ color: "green" }}>+32</Typography>{" "}
              ...
              >
                <Typography sx={{ color: "red" }}>-8</Typography>{" "}
